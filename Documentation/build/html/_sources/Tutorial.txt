...
The key part of the program is an instance of the NetWork.workgroup.Workgroup class, you control everything from this object. It's constructor takes an iterable (list, tuple, whatever) of worker IPs like this:
